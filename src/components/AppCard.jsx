...
const {FiHeart, FiCalendar, FiPhone} = FiIcons;

const AppCard = ({title, description, images, appUrl, icon}) => {
  const getAppPreview = () => {
    return (
      <div className="w-full mb-4 overflow-hidden rounded-xl">
        <div className="relative">
          ...
          <div className="flex space-x-3 pb-4">
            ...
            >
              <img
                src={images ? images[0] : "https://quest-media-storage-bucket.s3.us-east-2.amazonaws.com/1752629171188-IMG_2543.jpg"}
                alt={`${title} app preview screenshot 1`}
            ...
            >
              <img
                src={images ? images[1] : "https://quest-media-storage-bucket.s3.us-east-2.amazonaws.com/1752629176414-IMG_2541.jpg"}
                alt={`${title} app preview screenshot 2`}
                className="w-full h-auto object-cover"
              />
            </motion.div>
          </div>
          ...
          <div className="absolute -bottom-8 right-4 bg-white p-4 rounded-full shadow-lg">
            <div className="relative">
              <SafeIcon 
                icon={icon === "FiPhone" ? FiPhone : FiCalendar} 
    ...
    >
      <div className="p-6">
        ...
        <div className="mt-10 space-y-4">
          ...
          <motion.a
            href={appUrl || "https://essentialmemoriesapp.com"}
            target="_blank"
